...
function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">Transforming Healthcare with Kaizens</Heading>
      <Lead className="mt-6 max-w-3xl">
        Kaizens provides innovative healthcare solutions. We empower providers
        to deliver exceptional patient care. Our expertise optimizes revenue
        cycles and reduces administrative burdens.
      </Lead>
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          <h2 className="text-2xl font-medium tracking-tight">Our mission</h2>
          <p className="mt-6 text-sm/6 text-gray-600">
          Kaizens is one of the best providers of Revenue Cycle Management process and Analytics Solutions in the healthcare industry since 2023 . We understand the provider journey, pain points well and have solved provider end to end provider challenges effectively. We aim at delivering cost-effective technology-driven solutions and services to our providers.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
          With 50+ years of deep healthcare experience with two of the biggest US payors, we have participated in the evolution of US healthcare ecosystem, closely felt the pulse of a large provider network of clinicians and non-clinicians, and deeply engaged with varied health plans across 51 states.
          </p>
        </div>
